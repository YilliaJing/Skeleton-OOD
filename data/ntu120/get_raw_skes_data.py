...
def get_raw_bodies_data(skes_path, ske_name, frames_drop_skes, frames_drop_logger):
    ...
    if int(ske_name[1:4]) >= 18:
        skes_path = '/home/cvlab/additional-space/xj/data/nturgbd_raw/nturgb+d_skeletons120/'
...
if __name__ == '__main__':
    ...
    skes_path = '/home/cvlab/additional-space/xj/data/nturgbd_raw/nturgb+d_skeletons/'
    stat_path = osp.join(save_path, 'statistics')
    if not osp.exists('./raw_data'):  # 创建raw_data文件夹
