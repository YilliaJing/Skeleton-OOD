...
def get_groups(dataset='NTU', CoM=21):
    ...
    elif dataset == 'Kinetics':  # 用process里的graph求的tree结构
        if CoM == 1:
            groups.append([1])
            groups.append([2, 15, 16])
            groups.append([3, 6, 17, 18])
            groups.append([4, 9, 7, 12])
            groups.append([5, 10, 8, 13])
            groups.append([14, 11])

        elif CoM == 2:
            groups.append([2])
            groups.append([1, 3, 6])
            groups.append([15, 16, 4, 9, 7, 12])
            groups.append([17, 18, 5, 10, 8, 13])
            groups.append([11, 14])
